...
class TradeTracker_Connect_Model_Resource_Product_Collection extends Mage_Catalog_Model_Resource_Product_Collection
{
    ...
    public function isEnabledFlat()
    {
        ...
        if (Mage::getStoreConfig('tradetracker/generate/bypass_flat', $storeId)) {
            return false;
        }
